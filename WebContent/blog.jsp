...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
    ...
    <section id="blog" class="my-5 ">
        ...
        <div class=" py-5" >
            <div class="mb-3 mt-5" style="padding-left:80px; display: flex; align-items: center; justify-content: center;">
                <h2 class=" fw-bold display-4 mb-3"  style="font-family: Arial, Helvetica, sans-serif !important;padding-right: 90px;">Derniers Blogs</h2>
                <a href="blogServlet?action=create" class="btn btn-primary mb-5 mb-md-0">Ajouter Votre blog</a>
                <form action="blogServlet" method="get" style="margin-left: 80px; padding:5px;">
                    <input type="text" style="margin-left: 80px; padding:8px;" id="searchTitle" name="searchTitle" placeholder="Rechercher par titre... ">
        ...
        <div class="container ">
            <div class="row align-items-center justify-content-center d-flex">
               <c:forEach var="blog" items="${allBlogs}"> 
                ...
                <div class="col-md-6 col-lg-3" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); margin:10px;">
                    <div class="mb-3 ">
                        <div style="height: 350px; overflow: hidden;">
                            <a href="blogServlet?action=viewDetails&blogId=${blog.blogId}">
                                <img src="data:image/jpeg;base64,${blog.pictureBase64}" alt="Blog Image"class="img-fluid" style="width: 100%; height: auto; min-width: 100%; min-height: 100%;">
                            </a>
                        </div>                        
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="my-3">Ecrit par: ${blog.user.name}</h6>
                            <h6 class="my-3">Date: ${blog.publicationDate}</h6>
                        </div>
                        
                        
                        <a href="blogServlet?action=viewDetails&blogId=${blog.blogId}" class="text-decoration-none">
                            <h5 class="mb-3">${blog.title}</h5>
                        </a>
                        
                        <div class="d-flex align-items-center">
                        <a href="blogServlet?action=viewDetails&blogId=${blog.blogId}" class="btn btn-primary mt-3 mb-2">Lire article</a>
                         <c:if test="${user.id eq blog.user.id}">
                        <div style="margin-left: 20px;display: flex; align-items: center;">
                            <form lass="delete-form" action="blogServlet" method="post" onsubmit="return confirm('Are you sure you want to delete this blog?');" >
                                        <input type="hidden" name="action" value="delete">
                                        <input type="hidden" name="blogId" value="${blog.blogId}">
                                 <button type="submit" style="background: none; border: none; " onclick="deleteItem()">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z"/>
                                        <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
                                    </svg>
...
<script>
    function copyDescriptionToClipboard(blogId) {
        var blogDescription = document.getElementById('blogDescription_' + blogId).innerText;
        
        navigator.clipboard.writeText(blogDescription).then(function() {
