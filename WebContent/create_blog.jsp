...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
    ...
    <div class="text-center">
        <div class="container" style="margin-top: 120px; font-weight: 800;">
            <h1>Ajouter Votre Blog</h1>
        </div>
 <section id="hero" class="position-relative overflow-hidden d-flex align-items-center justify-content-center">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-5">
                <form action="blogServlet" method="post" enctype="multipart/form-data" class="hero-form p-5" style="margin-top: 20px; background-color: #f5f5f5;">
                    <input type="hidden" name="action" value="create">

                    <!-- Titre de l'article -->
                    <div class="mb-3">
                        <label for="title" class="form-label mb-1" style="font-weight: bold; font-size: 20px;">Titre de l'article: </label>
                        <input type="text" class="form-control border-1" id="title" name="title" placeholder="Titre..." required>
                    </div>

                    <!-- Description de l'article -->
                    <div class="mb-3">
                        <label for="description" class="form-label mb-1" style="font-weight: bold; font-size: 20px;">Description: </label>
                        <textarea id="description" name="description" class="form-control" placeholder="Description..." required></textarea>
                    </div>

                    <!-- Ajouter une image -->
                    <div class="mb-3 mt-4">
                        <label for="picture" class="mon-bouton">Ajouter une image</label>
